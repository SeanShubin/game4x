...
**to** spec · **status** open · **raised** 2026-09-13 · **source** Sean measuring a real game rather than reasoning about one: *12 spaces up returns to start, and 12 spaces right - alternating up-right, down-right - returns to start* · **found by** looking at something that shipped
