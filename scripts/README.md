...
| Script                    | Runs                                                           | Notes                                                               |
| ------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------------- |
| `game4x.ps1` / `.sh`      | [the application](../crates/game4x/)                           | Drag to turn the world, wheel to zoom, arrow keys to turn           |
| `web.ps1` / `.sh`         | the same application as WASM, on `localhost:8080`              | What GitHub Pages publishes, running locally                        |
