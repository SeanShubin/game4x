...
#
# It writes a drawing rather than opening a window - `prototypes/hex-torus-view/drawing/index.html`,
# ten worlds to step through and the numbers beside them. Open that file to see the answer.
#
...
exec cargo run --release -p hex-torus-view -- "$@"
