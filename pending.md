...
- **Q-84** - `1875e5c` Q-84 taken: the arm that caught an unchecked constant was satisfied by a comment · still open in `lenses/quality/outbox.md`
...
- **C-107** - Two proposals labelled `shape rows` offer a table that describes a change · `crates/outbox.md`
...
- **Q-85** - The new `shape rows` carrier sees one of the two legal forms, and was driven in that one · `lenses/quality/outbox.md`
...
- `spec/console.md` -> The language - P-254, P-287, P-284, P-321, P-353, P-323, P-328, P-356, P-366, P-378, P-396, P-417, P-418, P-443, P-448, P-451, P-452, P-454, P-460, P-462, P-464
