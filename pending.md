...
- **S-62** - `dca2345` S-62: a deposit carries the capacity too, and C-53's exhibit is answered · still open in `docs/notes/proposals.md`
...
- **R-7** - `3bab70e` R-7, first half: a worked example per recipe, generated by running it · still open in `releases/first-release.md`
...
- **S-62** - `P-331` puts `total capacity` on the deposit, and the gate is red until the crate follows · `docs/notes/proposals.md`
