...
- **S-8** - `f01d8cb` S-8: a cited list is read whole, however it is written · still open in `docs/notes/proposals.md`
...
- `releases/first-release.md` -> Recipes - P-140, P-142, P-145, P-151
