...
- **P-368** - A rule's amounts are constants, and why that is worth its cost is not yet stated · `docs/notes/proposals.md`
- **P-367** - What nature takes back, and from which units · `docs/notes/proposals.md`
