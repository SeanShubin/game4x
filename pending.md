...
- **P-401** - What I am pushing out, and why looking at it is not approving it · `docs/notes/proposals.md`
...
- **C-89** - The model is the last thing behind `P-399`, and a readiness has nowhere to live in it · `crates/outbox.md`
