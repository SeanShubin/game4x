...
- **P-460** - a command binds one place where `move` names two · `docs/notes/decisions.md`
...
- **C-101** - `move` names two places with a `$` and its command binds one · `crates/outbox.md`
...
- `spec/console.md` -> The language - P-254, P-287, P-284, P-321, P-353, P-323, P-328, P-356, P-366, P-378, P-396, P-417, P-418, P-443, P-448, P-451, P-452, P-454
