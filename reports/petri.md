...
The release states **27 blocks of recipe rows** under **20 names**. **27 of the blocks are drawn** and **0 are not**, as **42 transitions**.
...
**26 places and 154 arcs** between them: 72 `consume`, 39 `produce`, 43 `require`.
...
**It is too large to read whole, and saying so is half of what `R-10` asks.** 26 places and 42 transitions is 68 nodes, joined by 154 arcs - past the point where the eye follows one transition out of the bundle. **So the parts below are the drawing that can be read**: one per recipe, each with its own arcs written out, **and each saying which other recipes reach the same places**. A part that did not say that would read as the whole of a recipe's connections rather than as a part.
...
Leaves out 26 other recipes that reach these same places: bear, breed, build extractor, create labor, found by land, launch ark, perish, produce pioneer, renew, upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, launch ark, move, perish, renew, stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 33 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, move, perish, produce pioneer, renew, stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
