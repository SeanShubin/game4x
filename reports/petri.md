...
**31 places and 165 arcs** between them: 76 `consume`, 44 `produce`, 45 `require`.
...
**It is too large to read whole, and saying so is half of what `R-10` asks.** 31 places and 46 transitions is 77 nodes, joined by 165 arcs - past the point where the eye follows one transition out of the bundle. **So the parts below are the drawing that can be read**: one per recipe, each with its own arcs written out, **and each saying which other recipes reach the same places**. A part that did not say that would read as the whole of a recipe's connections rather than as a part.
...
- needs 1 unit, and does not take it - with room for energy
- takes 1 energy
- makes 1 energy in a unit's tank
- takes 1 room for energy in a unit's tank

Leaves out 10 other recipes that reach these same places: discard (energy), launch ark, move, produce pioneer, stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8).
...
Leaves out 28 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, launch ark, muster, perish, refuel, stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 33 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, muster, perish, produce pioneer, refuel, stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
