...
The release states **29 blocks of recipe rows** under **21 names**. **29 of the blocks are drawn** and **0 are not**, as **44 transitions**.
...
**27 places and 159 arcs** between them: 73 `consume`, 41 `produce`, 45 `require`.
...
**It is too large to read whole, and saying so is half of what `R-10` asks.** 27 places and 44 transitions is 71 nodes, joined by 159 arcs - past the point where the eye follows one transition out of the bundle. **So the parts below are the drawing that can be read**: one per recipe, each with its own arcs written out, **and each saying which other recipes reach the same places**. A part that did not say that would read as the whole of a recipe's connections rather than as a part.
...
| ark working           | a territory | ark working       |
...
| Place                 | deploy ark | move   | found by land | build extractor | build store | build yard | produce pioneer | launch ark | create labor | mine energy | work (energy x2) | work (energy x4) | work (energy x5) | work (energy x6) | work (energy x8) | work (food x1) | work (food x2) | work (food x3) | work (food x4) | work (food x6) | work (metal x2) | work (metal x3) | work (metal x4) | work (metal x5) | work (metal x6) | work (metal x8) | upkeep | bear | breed | perish | age | spoil | stow (metal) | stow (energy) | discard (metal) | discard (energy) | discard (labor) | discard (fertility) | refresh (unit moving) | refresh (citizen laboring) | refresh (citizen bearing) | refresh (extractor working) | refresh (ark working) | renew |
| --------------------- | ---------- | ------ | ------------- | --------------- | ----------- | ---------- | --------------- | ---------- | ------------ | ----------- | ---------------- | ---------------- | ---------------- | ---------------- | ---------------- | -------------- | -------------- | -------------- | -------------- | -------------- | --------------- | --------------- | --------------- | --------------- | --------------- | --------------- | ------ | ---- | ----- | ------ | --- | ----- | ------------ | ------------- | --------------- | ---------------- | --------------- | ------------------- | --------------------- | -------------------------- | ------------------------- | --------------------------- | --------------------- | ----- |
...
| unit                  |            | r1     |               |                 |             |            |                 |            |              |             |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |                       |       |
| unit moving           |            | -1     |               |                 |             |            |                 |            |              |             |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     | +1                    |                            |                           |                             |                       |       |
| energy                |            | -1     |               |                 |             |            | -2              | -12        |              | +1          | +2               | +4               | +5               | +6               | +8               |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              | -1, +1        |                 | -1               |                 |                     |                       |                            |                           |                             |                       |       |
| pioneer               |            |        | -1            |                 |             |            | +1              |            |              |             |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |                       |       |
...
Leaves out 27 other recipes that reach these same places: bear, breed, build extractor, create labor, found by land, launch ark, mine energy, perish, produce pioneer, renew, upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 11 other recipes that reach these same places: discard (energy), launch ark, mine energy, produce pioneer, refresh (unit moving), stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8).
...
Leaves out 26 other recipes that reach these same places: bear, breed, build extractor, create labor, deploy ark, launch ark, perish, produce pioneer, renew, upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 29 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, launch ark, mine energy, move, perish, renew, stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 34 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, mine energy, move, perish, produce pioneer, renew, stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 30 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, deploy ark, discard (labor), found by land, launch ark, perish, produce pioneer, refresh (citizen laboring), renew, upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).

### mine energy

- needs 1 territory in the game, and does not take it
- needs 1 ark, and does not take it - working at least 1
- takes 1 ark working - working one less
- makes 1 energy

Leaves out 23 other recipes that reach these same places: deploy ark, discard (energy), launch ark, move, produce pioneer, refresh (ark working), stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 29 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, mine energy, move, produce pioneer, refresh (extractor working), stow (energy), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 29 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, mine energy, move, produce pioneer, refresh (extractor working), stow (energy), work (energy x2), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 29 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, mine energy, move, produce pioneer, refresh (extractor working), stow (energy), work (energy x2), work (energy x4), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 29 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, mine energy, move, produce pioneer, refresh (extractor working), stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 27 other recipes that reach these same places: breed, build extractor, build store, build yard, create labor, deploy ark, discard (labor), found by land, launch ark, mine energy, refresh (extractor working), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (labor), discard (metal), found by land, launch ark, mine energy, produce pioneer, refresh (extractor working), stow (metal), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 14 other recipes that reach these same places: bear, breed, create labor, deploy ark, found by land, launch ark, perish, produce pioneer, renew, work (food x1), work (food x2), work (food x3), work (food x4), work (food x6).
...
Leaves out 11 other recipes that reach these same places: breed, create labor, deploy ark, discard (fertility), found by land, launch ark, perish, produce pioneer, refresh (citizen bearing), renew, upkeep.
...
Leaves out 15 other recipes that reach these same places: bear, create labor, deploy ark, discard (fertility), found by land, launch ark, perish, produce pioneer, renew, upkeep, work (food x1), work (food x2), work (food x3), work (food x4), work (food x6).

### perish

- takes 1 citizen - paid 0

Leaves out 9 other recipes that reach these same places: bear, breed, create labor, deploy ark, found by land, launch ark, produce pioneer, renew, upkeep.
...
Leaves out 10 other recipes that reach these same places: discard (energy), launch ark, mine energy, move, produce pioneer, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8).
...
Leaves out 10 other recipes that reach these same places: launch ark, mine energy, move, produce pioneer, stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8).
...
- makes 1 ark working - working at its maximum

Leaves out 1 other recipes that reach these same places: mine energy.
...
Leaves out 9 other recipes that reach these same places: bear, breed, create labor, deploy ark, found by land, launch ark, perish, produce pioneer, upkeep.
