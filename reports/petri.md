...
**It is too large to read whole, and saying so is half of what `R-10` asks.** 35 places and 51 transitions is 86 nodes, joined by 183 arcs - past the point where the eye follows one transition out of the bundle. **So the parts below are the drawing that can be read**: one per recipe, each with its own arcs written out, **and each saying which other recipes reach the same places**. A part that did not say that would read as the whole of a recipe's connections rather than as a part.
...
| citizen paid                     | a territory   | citizen paid      |
...
| nature                           | a territory   | nature            |
| nature met                       | a territory   | nature met        |
...
| Place                            | deploy ark | move   | refuel | found by land | build extractor | build store | build yard | produce pioneer | launch ark | create labor | work (energy x2) | work (energy x4) | work (energy x5) | work (energy x6) | work (energy x8) | work (food x1) | work (food x2) | work (food x3) | work (food x4) | work (food x6) | work (metal x2) | work (metal x3) | work (metal x4) | work (metal x5) | work (metal x6) | work (metal x8) | upkeep | bear | breed | perish | age | spoil | stow (metal) | stow (energy) | discard (metal) | discard (energy) | discard (labor) | discard (fertility) | refresh (unit moving) | refresh (citizen laboring) | refresh (citizen bearing) | refresh (extractor working) | muster | refresh (citizen defending) | refresh (unit defending) | hold | reclaim | renew (nature met) | renew (citizen paid) | take   | discard (force) |
| -------------------------------- | ---------- | ------ | ------ | ------------- | --------------- | ----------- | ---------- | --------------- | ---------- | ------------ | ---------------- | ---------------- | ---------------- | ---------------- | ---------------- | -------------- | -------------- | -------------- | -------------- | -------------- | --------------- | --------------- | --------------- | --------------- | --------------- | --------------- | ------ | ---- | ----- | ------ | --- | ----- | ------------ | ------------- | --------------- | ---------------- | --------------- | ------------------- | --------------------- | -------------------------- | ------------------------- | --------------------------- | ------ | --------------------------- | ------------------------ | ---- | ------- | ------------------ | -------------------- | ------ | --------------- |
| territory in the game            | r1         |        | r1     |               |                 |             |            |                 | r1         |              | r1               | r1               | r1               | r1               | r1               | r1             | r1             | r1             | r1             | r1             | r1              | r1              | r1              | r1              | r1              | r1              |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| force                            | r1         |        |        | r1            |                 |             |            |                 |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             | +1     |                             |                          | -1   |         |                    |                      | -1     | -1              |
| ark                              | -1         |        |        |               |                 |             |            |                 | +1         |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| room for ark                     | +1         |        |        |               |                 |             |            |                 | -1         |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| garrison                         | +1         |        |        | +1            |                 |             |            |                 |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             | r1     |                             |                          |      |         |                    |                      |        |                 |
| room for garrison                | -1         |        |        | -1            |                 |             |            |                 |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| citizen                          | +2         |        |        | +2            |                 |             |            | -2              | -2         | r1           |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 | r1     | r1   | +1    | -1     |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             | r1     |                             |                          |      | -1      |                    | r1                   |        |                 |
| extractor                        | +1, +1     |        |        | +1, +1        | +1              |             |            |                 |            |              | r1               | r1               | r1               | r1               | r1               | r1             | r1             | r1             | r1             | r1             | r1              | r1              | r1              | r1              | r1              | r1              |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| room for extractor               | -1, -1     |        |        | -1, -1        | -1              |             |            |                 |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| place in the game                |            | r1, r1 |        |               |                 |             |            |                 |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| unit                             |            | r1     | r1     |               |                 |             |            |                 |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| unit moving                      |            | -1     |        |               |                 |             |            |                 |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     | +1                    |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| energy in a unit's tank          |            | -1     | +1     |               |                 |             |            |                 |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| room for energy in a unit's tank |            | +1     | -1     |               |                 |             |            |                 |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| energy                           |            |        | -1     |               |                 |             |            | -2              | -12        |              | +2               | +4               | +5               | +6               | +8               |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              | -1, +1        |                 | -1               |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
| pioneer                          |            |        |        | -1            |                 |             |            | +1              |            |              |                  |                  |                  |                  |                  |                |                |                |                |                |                 |                 |                 |                 |                 |                 |        |      |       |        |     |       |              |               |                 |                  |                 |                     |                       |                            |                           |                             |        |                             |                          |      |         |                    |                      |        |                 |
...
- needs 1 force, and does not take it
- takes 1 ark
- makes 1 room for ark
- makes 1 garrison
...
Leaves out 32 other recipes that reach these same places: bear, breed, build extractor, create labor, discard (force), found by land, hold, launch ark, muster, perish, produce pioneer, reclaim, refuel, renew (citizen paid), take, upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 2 other recipes that reach these same places: refresh (unit moving), refuel.

### refuel

- needs 1 territory in the game, and does not take it
- needs 1 unit, and does not take it - free energy at least 1
- takes 1 energy
- makes 1 energy in a unit's tank
- takes 1 room for energy in a unit's tank

Leaves out 22 other recipes that reach these same places: deploy ark, discard (energy), launch ark, move, produce pioneer, stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 31 other recipes that reach these same places: bear, breed, build extractor, create labor, deploy ark, discard (force), hold, launch ark, muster, perish, produce pioneer, reclaim, renew (citizen paid), take, upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 30 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, launch ark, muster, perish, reclaim, refuel, renew (citizen paid), stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
- makes 1 ark
- takes 1 room for ark

Leaves out 35 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, muster, perish, produce pioneer, reclaim, refuel, renew (citizen paid), stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 32 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, deploy ark, discard (labor), found by land, launch ark, muster, perish, produce pioneer, reclaim, refresh (citizen laboring), renew (citizen paid), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, produce pioneer, refresh (extractor working), refuel, stow (energy), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, produce pioneer, refresh (extractor working), refuel, stow (energy), work (energy x2), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, produce pioneer, refresh (extractor working), refuel, stow (energy), work (energy x2), work (energy x4), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, produce pioneer, refresh (extractor working), refuel, stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 27 other recipes that reach these same places: breed, build extractor, build store, build yard, create labor, deploy ark, discard (labor), found by land, launch ark, refresh (extractor working), refuel, upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (labor), discard (metal), found by land, launch ark, produce pioneer, refresh (extractor working), refuel, stow (metal), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
- takes 1 food
- makes 1 citizen paid - paid at its maximum

Leaves out 16 other recipes that reach these same places: bear, breed, create labor, deploy ark, found by land, launch ark, muster, perish, produce pioneer, reclaim, renew (citizen paid), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6).
...
Leaves out 13 other recipes that reach these same places: breed, create labor, deploy ark, discard (fertility), found by land, launch ark, muster, perish, produce pioneer, reclaim, refresh (citizen bearing), renew (citizen paid), upkeep.
...
Leaves out 17 other recipes that reach these same places: bear, create labor, deploy ark, discard (fertility), found by land, launch ark, muster, perish, produce pioneer, reclaim, renew (citizen paid), upkeep, work (food x1), work (food x2), work (food x3), work (food x4), work (food x6).

### perish

- takes 1 citizen - paid 0

Leaves out 11 other recipes that reach these same places: bear, breed, create labor, deploy ark, found by land, launch ark, muster, produce pioneer, reclaim, renew (citizen paid), upkeep.
...
Leaves out 9 other recipes that reach these same places: discard (energy), launch ark, produce pioneer, refuel, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8).
...
Leaves out 9 other recipes that reach these same places: launch ark, produce pioneer, refuel, stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8).
...
Leaves out 15 other recipes that reach these same places: bear, breed, create labor, deploy ark, discard (force), found by land, hold, launch ark, perish, produce pioneer, reclaim, refresh (citizen defending), renew (citizen paid), take, upkeep.
...
- needs 1 nature, and does not take it - met 0
- takes 1 force
- makes 1 nature met - met at its maximum

Leaves out 7 other recipes that reach these same places: deploy ark, discard (force), found by land, muster, reclaim, renew (nature met), take.
...
Leaves out 14 other recipes that reach these same places: bear, breed, create labor, deploy ark, found by land, hold, launch ark, muster, perish, produce pioneer, renew (citizen paid), renew (nature met), take, upkeep.

### renew (nature met)

- needs 1 nature, and does not take it
- takes 1 nature met - met 0

Leaves out 3 other recipes that reach these same places: hold, reclaim, take.

### renew (citizen paid)

- needs 1 citizen, and does not take it
- takes 1 citizen paid - paid 0

Leaves out 11 other recipes that reach these same places: bear, breed, create labor, deploy ark, found by land, launch ark, muster, perish, produce pioneer, reclaim, upkeep.
...
Leaves out 7 other recipes that reach these same places: deploy ark, discard (force), found by land, hold, muster, reclaim, renew (nature met).

### discard (force)

- takes 1 force

Leaves out 5 other recipes that reach these same places: deploy ark, found by land, hold, muster, take.
