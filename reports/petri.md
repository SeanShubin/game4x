...
**33 places and 177 arcs** between them: 81 `consume`, 45 `produce`, 51 `require`.
...
**It is too large to read whole, and saying so is half of what `R-10` asks.** 33 places and 50 transitions is 83 nodes, joined by 177 arcs - past the point where the eye follows one transition out of the bundle. **So the parts below are the drawing that can be read**: one per recipe, each with its own arcs written out, **and each saying which other recipes reach the same places**. A part that did not say that would read as the whole of a recipe's connections rather than as a part.
...
Leaves out 31 other recipes that reach these same places: bear, breed, build extractor, create labor, discard (force), found by land, hold, launch ark, muster, perish, produce pioneer, reclaim, renew (citizen paid), take, upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 10 other recipes that reach these same places: discard (energy), launch ark, produce pioneer, refresh (unit moving), stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8).
...
Leaves out 30 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, launch ark, move, muster, perish, reclaim, renew (citizen paid), stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 35 other recipes that reach these same places: bear, breed, build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (metal), found by land, move, muster, perish, produce pioneer, reclaim, renew (citizen paid), stow (energy), stow (metal), upkeep, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, move, produce pioneer, refresh (extractor working), stow (energy), work (energy x4), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, move, produce pioneer, refresh (extractor working), stow (energy), work (energy x2), work (energy x5), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, move, produce pioneer, refresh (extractor working), stow (energy), work (energy x2), work (energy x4), work (energy x6), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 28 other recipes that reach these same places: build extractor, build store, build yard, create labor, deploy ark, discard (energy), discard (labor), found by land, launch ark, move, produce pioneer, refresh (extractor working), stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x8), work (food x1), work (food x2), work (food x3), work (food x4), work (food x6), work (metal x2), work (metal x3), work (metal x4), work (metal x5), work (metal x6), work (metal x8).
...
Leaves out 9 other recipes that reach these same places: discard (energy), launch ark, move, produce pioneer, work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8).
...
Leaves out 9 other recipes that reach these same places: launch ark, move, produce pioneer, stow (energy), work (energy x2), work (energy x4), work (energy x5), work (energy x6), work (energy x8).
