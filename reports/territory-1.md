...
**Generated. Do not edit.** The diffable sibling of the page; it carries the same rows without
the links, so that a change to the state is a change to one line here.

**Reached from here** territory 2, territory 3, territory 4, territory 5, territory 6
